*-------------------------------------------------------------------------------
* Filename:     12_build_master.do
* Purpose:      Merge every piece into the master analysis file.
...
**************************************************************************************************************
************ Code for mering all local economies data + fish diversification/ broader share ******************
**************************************************************************************************************
**************************************************************************************************************
...
// *Load geomatric growth rate and instability
// use "$DERIVED/growth_rate_instability_geom_local.dta"
...
// Calculate the median value of div_emp_diff and generate the dummy variable
...
*==============================================================================*
* Checks  (ADDED for the replication package -- no data is modified here)
*==============================================================================*
* WHY: the merges above are m:1 on `city` and silently tolerate non-matches.
* These assertions turn a bad merge into an immediate, named failure.
