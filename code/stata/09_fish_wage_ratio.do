*-------------------------------------------------------------------------------
* 09_fish_wage_ratio.do: Ratio of fishing revenue to wage income, unimputed.
...
drop if count < 7
* Note that: fishing communities that have 0 values at a given year for earning is there are permit holders but they didn't fish.
